        ...
        <div className={`${simulateContext.simulateVisible ? 'flex':'hidden'} animate-fade opacity-0 fixed top-0 left-0 w-screen h-screen backdrop-blur-sm justify-center items-center z-10`}>
            ...
            <div className={`w-fit tabletMini:w-4/6 destkopMini:w-2/4 mobileMedium:w-5/6 h-fit p-4 desktopBig:p-10 desktopMedium:p-6 flex border-2 border-gray-400 dark:border-gray-700 bg-white dark:bg-[#111111] rounded-md flex-col justify-center desktopMedium:gap-5 gap-3`}>
                <div className="w-full h-fit flex justify-between">
                    <div className="mobileMedium:text-lg desktopMedium:text-2xl desktopBig:text-3xl destkopMini:text-xl">
                        Simulação
                    </div>
                    <div>
                ...
                <div className={`${tableVisible ? 'block':'hidden'}`}>
                    <table cellPadding={10} className="text-sm tabletMini:text-base desktopMedium:text-xl border w-full border-gray-400 dark:border-gray-700">
                        <thead>
                            <tr>
                                <th className="p-1 border border-gray-400 dark:border-gray-700 desktopMedium:text-2xl desktopMedium:p-2 desktopBig:text-3xl desktopBig:p-3 tabletMini:text-lg">elemento</th>
                                <th className="p-1 border border-gray-400 dark:border-gray-700 desktopMedium:text-2xl desktopMedium:p-2 desktopBig:text-3xl desktopBig:p-3 tabletMini:text-lg">valor</th>
                                <th className="p-1 border border-gray-400 dark:border-gray-700 desktopMedium:text-2xl desktopMedium:p-2 desktopBig:text-3xl desktopBig:p-3 tabletMini:text-lg">resultado</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700">{itemName}</td>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700">R$: {Number(itemValue)}</td>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700">---</td>
                            </tr>
                            <tr>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700">Saldo</td>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700">R$: {saldo}</td>
                                <td className={`p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700 ${saldo_rest}`}>R$: {saldoResult}</td>
                            </tr>
                            <tr>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700">gastos</td>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700">R$: {gastos}</td>
                                <td className="p-1 desktopBig:p-3 desktopBig:text-xl border border-gray-400 dark:border-gray-700 text-yellow-500">R$: {gastosResult}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div className="w-full h-fit flex justify-end">
                    <button onClick={HandleSimulate} className="bg-[#003362] text-[#eee] py-1 px-2 desktopMedium:text-lg desktopBig:text-xl desktopBig:px-5 mobileMedium:py-2 rounded-md  text-sm border-2 border-[#205D9E]">
                        Simular
                    </button>
                </div>
            </div>
