...
export const SwitchButton = () => {
    ...
    return (
        <button onClick={HandleSwitchMode} className="border group border-[#414141] p-2 desktopBig:p-3 rounded-md hover:bg-gray-700 transition-all">
            {theme === 'dark' ? 
                ...
                :
                <SunSVG className="fill-[#414141] mobileMini:h-5 desktopMedium:h-7 desktopBig:w-9 desktopBig:h-9 desktopMedium:w-7 mobileMini:w-5 group-hover:fill-[#eeeeee]"/>
            }
        </button>
    )
